...
public class AddNewGiftItemActivity extends BaseActivity {
    private ProgressDialog mProgressDialog;

    private static final String TAG = AddNewGiftItemActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleField = (EditText) findViewById(R.id.field_giftName);
        ...
        mImageView = (ImageView) findViewById(R.id.imageView_giftImage);
                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (user == null) {
                            ...
                            Toast.makeText(AddNewGiftItemActivity.this,
    ...
    private void writeNewGift(String title, String description, Uri imageUrl, String userId) {
        ...
        childUpdates.put("/user-gifts/" + key, giftValues);
    ...
    private void uploadFromUri(Uri fileUri) {
        ...
        startService(new Intent(this, MyUploadService.class)
                ...
                .putExtra(MyUploadService.EXTRA_FILE_DIRECTOY_NAME, "gift_photos")
    ...
    private void setUpToolBar() {
        ...
        getSupportActionBar().setTitle("New Gift Item");
    }

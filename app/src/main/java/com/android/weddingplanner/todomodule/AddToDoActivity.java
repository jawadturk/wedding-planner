...
//        setContentView(R.layout.activity_add_to_do);
        ...
        mUserToDoItem = (ToDoItem) getIntent().getSerializableExtra(TodoActivity.TODOITEM);
...
//        }
        ...
        if (theme.equals(TodoActivity.DARKTHEME)) {
...
//            mTimeEditText.setText(timeOption);
    ...
    private String getThemeSet() {
        return getSharedPreferences(TodoActivity.THEME_PREFERENCES, MODE_PRIVATE).getString(TodoActivity.THEME_SAVED, TodoActivity.LIGHTTHEME);
    }
...
//        mUserToDoItem.setLastEdited(mLastEdited);
        ...
        i.putExtra(TodoActivity.TODOITEM, mUserToDoItem);
        setResult(result, i);
    }

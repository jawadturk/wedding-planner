...
public class ToDoItem implements Serializable {
    ...
    private boolean mMarkedAsDone = false;
    ...
    private static final String TODOMARKED = "todomarked";
    ...
    public ToDoItem(String todoBody, boolean hasReminder, Date toDoDate, boolean markedAsDone) {
        mToDoText = todoBody;
        mMarkedAsDone = markedAsDone;
    ...
    public ToDoItem(JSONObject jsonObject) throws JSONException {
        ...
        mMarkedAsDone = jsonObject.getBoolean(TODOMARKED);
...
//        }
    ...
    public JSONObject toJSON() throws JSONException {
        ...
        jsonObject.put(TODOMARKED, mMarkedAsDone);
...
//        jsonObject.put(TODOLASTEDITED, mLastEdited.getTime());
    ...
    public boolean getMarkedAsDone() {
        return mMarkedAsDone;
    }

    public void setmMarkedAsDone(boolean mMarkedAsDone) {
        this.mMarkedAsDone = mMarkedAsDone;
    }

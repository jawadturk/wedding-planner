...
public class ReminderActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        theme = getSharedPreferences(TodoActivity.THEME_PREFERENCES, MODE_PRIVATE).getString(TodoActivity.THEME_SAVED, TodoActivity.LIGHTTHEME);
        if (theme.equals(TodoActivity.LIGHTTHEME)) {
        ...
        storeRetrieveData = new StoreRetrieveData(this, TodoActivity.FILENAME);
        mToDoItems = TodoActivity.getLocallyStoredData(storeRetrieveData);
...
//        mSnoozeSpinner.setSelection(0);
    ...
    private void closeApp() {
        Intent i = new Intent(ReminderActivity.this, TodoActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//        i.putExtra(EXIT, true);
        SharedPreferences sharedPreferences = getSharedPreferences(TodoActivity.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
    ...
    private void changeOccurred() {
        SharedPreferences sharedPreferences = getSharedPreferences(TodoActivity.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean(TodoActivity.CHANGE_OCCURED, true);
//        editor.commit();
        editor.apply();
    }
